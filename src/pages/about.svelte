...
<h1 class="logo center">
	<img src={logo} alt="Meewer" height="80" />
</h1>
...
<div class="center links">
	...
	|
	<a
		href="https://github.com/meewer-media-co"
		target="_blank"
...
<Container>
	<h2>The Council</h2>
	<p>These people have the highest authority of the Meewer project.</p>
	<div class="contributors-list">
		<Contributor username="WlodekM3" pfp={27} isMeeewer={true}>
			Current owner of Meewer
		</Contributor>
		<Contributor username="barney86" pfp={26} isMeeewer={true}>
			Co-Owner of Meewer
		</Contributor>
	</div>
</Container>
...
<Container>
	...
	<Container>
		...
		<ul>
			<li>
				Routing (you can now share links to specific pages on Meewer!)
			</li>
	...
	<Container>
		...
		<ul>
			...
			<li>
				...
				is an image host whitelist of a few sites (Meewer, Tenor,
		...
		<details>
			...
			<ul>
				<li>Search page</li>
				<li>BetterMeewer profile picture support</li>
				<li>Statisics</li>
	...
	<Container>
		...
		<ul>
			...
			<li>
				Rename page title from "Meewer Svelte" to "Meewer" to reflect it
