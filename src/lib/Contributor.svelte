<script>
	...
	export let url = "";
	export let pfp = null;
	export let isMeewer = false;
	export let isMeeewer = false;

	$: if (isMeewer) url = "https://app.meower.org/users/" + username;
	$: if (isMeeewer) url = "/users/" + username;
</script>
...
>
	{#if (isMeewer || isMeeewer) && pfp != null}
